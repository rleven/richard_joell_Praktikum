...
plt.errorbar(a, unp.nominal_values(d), yerr=unp.std_devs(d), fmt='g-', label='Theoriekurve')
plt.plot(a, unp.nominal_values(d1), 'b-', label='Ausgleichskurve')
plt.xlabel(r't in $s$')
plt.ylabel(r'U in $V$')
plt.legend(loc='best')
